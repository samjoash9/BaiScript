...
export default function IDEPage() {
    ...
    useEffect(() => { localStorage.setItem('machineCode', machineCode); }, [machineCode]);
    ...
    const handleRun = async () => {
        ...
        setIsRunning(true);
        setOutput(''); setTargetCode(''); setMachineCode('');
    ...
    const handleClearOutput = () => { setOutput(''); setTargetCode(''); setMachineCode(''); };
